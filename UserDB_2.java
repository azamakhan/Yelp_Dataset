...
public class UserDB_2 {
	...
	public static int insert(User_2 user) throws SQLException {
	...
	public static int delete_listing(User_2 user) throws SQLException {

		PreparedStatement ps = null;
	
		String query_ins = "INSERT INTO rented_apartments SELECT * FROM apartments WHERE" + "VALUES (?, ?, ?)";
	//	String query = "DELETE FROM Userdb " + "WHERE Email = ?";
		try {
			ps = connection.prepareStatement(query_ins);
			ps.setString(1, user.getEmail());
	...
	public static int delete(User_2 user) throws SQLException {
